...
###################
 ...
 ## metadata table on sizes of individuals 
	...
	meta.flextable <- m2 %>%
		...
		autofit()
	meta.flextable
	save_as_image(meta.flextable, 'onlypredatorsinstudyareaandtime_predators_PCL_tagDate_tagLocation.png', webshot='webshot')
...
###################
  ...
  names(labels) = c('H','L')
	...
	ggsave(relativePropPDdettsreceivers,file='relativepredatorrisk_at_receivers.png',device='png',units='in',dpi=650, height = 3.25,width=4)
...
###################
	...
	ggsave(sgPCAplot,file='seagrassesPCA_distributionplot_forchpater3writeup_.png',device=png,units='in',height=8,width=4.2,dpi=850)
...
###################
	...
	ggsave(plot,file='sgPCA_maxN_and_relRisk_chp3.png',device='png',units='in',dpi=950,height=4.5)		
...
##############################################
	...
	# Get n.trees and mean deviance of original & simplified models 
		...
		save_as_image(info2,'BRT_maxN_july2024/ntrees_and_deviance_of_full_and_simpleBRTS_chp3_july2024.png',webshot='webshot')
		save_as_docx(info2, path='BRT_maxN_july2024/ntrees_and_deviance_of_full_and_simpleBRTS_chp3_july2024.docx')
...
# read in model RDS
	sgm <- readRDS('seagrasses_glm_hypotesting_distancemetrics_july24.RDS')
	fm <- readRDS('fishesmetric_glm_hypotesting_distancemetrics_MaxN_July24.RDS')
	pm <- readRDS('largesharks_relativerisk_glm_hypotesting_distancemetrics_may24.RDS')
...
# make table
	...
	save_as_image(stacked.summary,'stackedsummarytables_hypotheses_chp3_seagrasses_fish_largesharks_glms_July2024.png' ,webshot='webshot')
	save_as_docx(stacked.summary,path = 'stackedsummarytables_hypotheses_chp3_seagrasses_fish_largesharks_glms_July2024.docx')
...
##############################################
	...
	samplesList5a <- readRDS('mcmcsamples_model5a_niter5000_burn1000_chains3_July2024.RDS')
	...
	save_as_image(pathwayresults_table,path='pathwayresultssummary_model5a_niter5000_burn1000_chains3_July2024.png')	
	save_as_docx(pathwayresults_table,path='pathwayresultssummary_model5a_niter5000_burn1000_chains3_July2024.docx')	
...
##############################################
  ...
  hexsf <- st_as_sf(st_read('data_for_bayes_structural_EQ_modelling_DF2_HEXAGONpredictions_andBRTs_july24.shp'),crs='WGS84')%>%
	...
	p3pred <- readRDS('path3_means_andHDI_at_hexagons_model5a_july2024.RData')
  ...
  # upper and lower side by side 
	...
	## path 3 prediction plot, mean, with 2 receivers of highest predaiton risk score and the jetties marked 
	  ...
	  p3.mean.withlocations <- ggplot()+
	   ...
	   ggsave(p3.mean.withlocations, file = 'path_inference/path3_mean_estimates_spatial_withtop2RelRisk_jetties_model5_july24.png', device = 'png', unit = 'in', dpi = 900, width = 5)
