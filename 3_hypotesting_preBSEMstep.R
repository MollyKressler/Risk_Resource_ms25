...
#############################
	...
	sg.modelsranked.tabled <- sg.dredge %>%
	  ...
	  save_as_image(sg.modelsranked.tabled,'dredged_results_seagrass_response_depth_dist2shore_distcmg_dist2jetty_Oct2024.png',webshot='webshot')
...
#############################
	...
	fish.modelsranked.tabled <- fish.dredge%>%
	 ...
	 filter(!is.na(estimate)) %>%
	  ...
	  save_as_image(fish.modelsranked.tabled,'dredged_results_fishHEXresponse_Oct2024.png',webshot='webshot')
...
#############################
  ...
  ## predators, point
	...
	press.glm.modelsranked.tabled <- pred.dredged%>%
	  ...
	  save_as_image(press.glm.modelsranked.tabled,'dredged_results_RelPropPDresponse_depth_dist2shore_distcmg_dist2jetty_tide_oct2024.png',webshot='webshot')
...
# save the models as RDS 
	saveRDS(sgm,'seagrasses_glm_hypotesting_distancemetrics_oct2024.RDS')
	saveRDS(fm,'fishesmetric_glm_hypotesting_distancemetrics_MaxN_oct2024.RDS')
	saveRDS(pm,'largesharks_relativerisk_glm_hypotesting_distancemetricsoct2024.RDS')
...
# read in model RDS
	sgm <- readRDS('seagrasses_glm_hypotesting_distancemetrics_oct2024.RDS')
	fm <- readRDS('fishesmetric_glm_hypotesting_distancemetrics_MaxN_oct2024.RDS')
	pm <- readRDS('largesharks_relativerisk_glm_hypotesting_distancemetricsoct2024.RDS')
...
# make table
	...
	save_as_image(stacked.summary,'stackedsummarytables_hypotheses_chp3_seagrasses_fish_largesharks_glms_Oct2024.png' ,webshot='webshot')
	save_as_docx(stacked.summary,path = 'stackedsummarytables_hypotheses_chp3_seagrasses_fish_largesharks_glms_Oct2024.docx')
...
#############################
    ...
    # calculate fitted and pull residuals 
		...
		ggsave(diagnostics_sgm, file = 'diagnostic_plots_sagrasses_hypotestingGLM_oct2024.png', device = 'png', unit = 'in', width = 8, height = 4, dpi = 850)
		ggsave(diagnostics_fm, file = 'diagnostic_plots_fishMaxN_hypotestingGLM_oct2024.png', device = 'png', unit = 'in', width = 8, height = 4, dpi = 850)
		ggsave(diagnostics_pm, file = 'diagnostic_plots_relrisk_hypotestingGLM_oct2024.png', device = 'png', unit = 'in', width = 8, height = 4, dpi = 850)		

		ggsave(diagnostics_stacked, file = 'diagnostic_plots_hypotestingGLM_oct2024.png', device = 'png', unit = 'in', width = 8, height = 10, dpi = 850)
